...
export const personas: Persona[] = [
  {
    ...
    story:
      "초등학생 지우는 PROMERA와 대화하며 궁금한 걸 질문하는 법을 배웠어요. 이제 숙제를 베끼는 대신, AI에게 좋은 질문을 던지며 스스로 답을 찾아요.",
  },
  {
    emoji: "👵",
    tag: "B2G · 시니어 디지털 교육",
    ...
    story:
      "스마트폰도 어려웠던 김 여사님은 PROMERA의 친절한 코칭 질문을 따라가며 AI에게 말 거는 법을 배웠어요. 이제 병원 예약 문의도 AI로 해결해요.",
  },
  {
    emoji: "📣",
    tag: "B2C · 마케터",
    ...
    story:
      "홍보글이 막막했던 1인 카페 사장님이 PROMERA에서 프롬프트를 훈련한 뒤, 인스타 콘텐츠를 매일 직접 만들어 방문 고객이 늘었어요.",
  },
  {
    emoji: "📄",
    tag: "B2B · 직장인",
